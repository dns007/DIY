...
import com.dns007.spring.ServiceInvocationHandler;
import com.dns007.util.ClassUtil;
import com.dns007.util.TransactionUtil;
...
public class MyApplication {
    ...
    private static final String PACKAGE_NAME = "com.dns007";
    ...
    public static void main(String[] args) {
        ...
        // 调用示例
        MyService myService = (MyService)initObject(context, "myServiceImpl");
        myService.addUser();
